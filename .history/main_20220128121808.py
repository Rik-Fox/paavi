...
def checkPaused(driver, paused):
    for entry in driver.get_log("browser"):
        ...
        if entry["message"] == f"localhost:{envision_port}/main.js 384:88417 true":
            print()
            print("Paused")
            print()
            return True
        elif entry["message"] == f"localhost:{envision_port}/main.js 384:88417 false":
            print()
            print("Playing")
            print()
            return False
...
def main(config):
    ...
    driver.get(f"localhost:{envision_port}")
